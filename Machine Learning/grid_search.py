#Grid Search
#This will help you find the best model to choose for the machine learning problem
...
grid_search = GridSearchCV(estimator = classifier, param_grid = paramters, scoring = 'accuracy', cv = 10, n_jobs = -1)
